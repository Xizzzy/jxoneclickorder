    ...
    <div class="form-wrapper">
        <div class="form-group">
            <label class="control-label col-lg-3">
                {l s='Description' mod='jxoneclickorder'}
            </label>
            <div class="col-lg-9">
                {foreach $languages as $language}
                    {if $languages|count > 1}
                        ...
                        <div class="col-lg-9">
                    {/if}
                    <textarea readonly="readonly" name="JXONECLICKORDER_SUCCESS_DESCRIPTION_{$language.id_lang|escape:'htmlall':'UTF-8'}" id="JXONECLICKORDER_SUCCESS_DESCRIPTION_{$language.id_lang|escape:'htmlall':'UTF-8'}" class="rte autoload_rte">
                        {$module_settings.JXONECLICKORDER_SUCCESS_DESCRIPTION[$language.id_lang]|escape:'htmlall':'UTF-8'}
                    </textarea>
                    {if $languages|count > 1}
                        </div>
                        <div class="col-lg-2 jxoneclickorder-button-lang">
